...
- [ ] **Phase 1: Demo Promise Hardening** - Preserve the existing local patient and clinician demo while tightening responsiveness, local-state clarity, and safety boundaries.
- [ ] **Phase 2: Auth and Session Model** - Replace the fake production role switch with explicit signed-out, onboarding, patient, clinician, and refresh-safe session states.
- [ ] **Phase 3: Privacy and Repository Contract Hardening** - Make clinician-facing paths incapable of reading patient journals while preserving consented sleep-summary access.
...
|-------|----------------|--------|-----------|
| 1. Demo Promise Hardening | 0/TBD | Not started | - |
| 2. Auth and Session Model | 0/TBD | Not started | - |
| 3. Privacy and Repository Contract Hardening | 0/TBD | Not started | - |
